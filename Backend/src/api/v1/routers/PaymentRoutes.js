...
Routers.post('/paymentVerification', PaymentController().paymentVerification); //Verfiying the payment of the user, after the payment, using POST '/api/payment/paymentVerification?user_id=""' 
